...
class Leader:
    ...
    def set_poef_saf_count(self, count: int):
        """Set the total number of cigarettes from the paper list."""
        self.poef_saf_count = count
    
    def add_poef_safs(self, count: int):
        """Add cigarettes to the existing count."""
        self.poef_saf_count += count
    
    def get_poef_total(self) -> float:
        """Calculate total POEF expenses."""
        return self.poef_drink_count * POEF_DRINK_PRICE + self.poef_saf_count * POEF_SAF_PRICE
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "poef_saf_count": self.poef_saf_count,
